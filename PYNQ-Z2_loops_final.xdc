...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { ledCLK }];
...
# and the DRC points to it. Let's assume led0[0] corresponds to what was Sch=led[2] (LD2).
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { ledEnable[0]}]; #IO_L21N_T3_DQS_AD14N_35 Sch=led[2]
# If you also have LD3 in your HDL and want to use it
 set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { ledEnable[0]}]; #IO_L23P_T3_35 Sch=led[3]
...
#set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { sig1}]; #IO_L4P_T0_35 Sch=btn[0]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sig1_IBUF]
#set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { sig2 }]; #IO_L4N_T0_35 Sch=btn[1]
...
#set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports {sig2}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sig2_IBUF]
#set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports {sig1}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sig1_IBUF]

#set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {PmodA[0]}]
#set_property PULLUP PULLDOWN [get_ports {PmodA[0]}]

#set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {PmodA[1]}]
#set_property PULLUP PULLDOWN [get_ports {PmodA[1]}]

#set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {PmodA[2]}]
#set_property PULLUP PULLDOWN [get_ports {PmodA[2]}]

#set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {PmodA[3]}]
#set_property PULLUP PULLDOWN [get_ports {PmodA[3]}]

#set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {PmodA[4]}]
#set_property PULLUP PULLDOWN [get_ports {PmodA[4]}]

#set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports {PmodA[5]}]
#set_property PULLUP PULLDOWN [get_ports {PmodA[5]}]

##set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {JA[4]}]
#set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports {sig2}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sig2_IBUF]
#set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {JA[3]}]
#set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {JA[6]}]
#set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {JA[5]}]
#set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {sig0}]
...
set_property DONT_TOUCH true [get_nets clk_out1_sig]
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
connect_debug_port dbg_hub/clk [get_nets clk_out2_sig]

set_property BEL A5FF [get_cells {design_1_i/top_0/inst/delay_line1/latch_cycle_nbr[3].latch_nbr[297].FDR_1}]
set_property LOC SLICE_X66Y74 [get_cells {design_1_i/top_0/inst/delay_line1/latch_cycle_nbr[3].latch_nbr[297].FDR_1}]
